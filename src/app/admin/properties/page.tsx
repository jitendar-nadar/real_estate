          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-700">
                <th className="px-4 py-3 font-medium text-slate-900 dark:text-white">Title</th>
                <th className="px-4 py-3 font-medium text-slate-900 dark:text-white">Location</th>
                <th className="px-4 py-3 font-medium text-slate-900 dark:text-white">Price</th>
                <th className="px-4 py-3 font-medium text-slate-900 dark:text-white">Type</th>
              ...
              {properties.map((p) => (
                ...
                >
                  <td className="px-4 py-3 text-slate-900 dark:text-white max-w-[200px] truncate">
                    {p.title}
                    {p.featured && (
                      <span className="ml-2 inline-flex rounded bg-primary-100 dark:bg-primary-900/30 px-1.5 py-0.5 text-xs text-primary-700 dark:text-primary-300">
                        Featured
                      </span>
                    )}
                  </td>
                  ...
                  <td className="px-4 py-3 text-slate-600 dark:text-slate-400 capitalize">{p.type}</td>
                  ...
                  <td className="px-4 py-3">
                    <AdminPropertyActions propertyId={p.id} deletedAt={p.deletedAt ?? undefined} />
                  </td>
                </tr>
              ))}
            </tbody>
